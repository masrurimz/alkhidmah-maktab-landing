...
function MaktabLive() {
  const isVisible = useMaktabLiveStore((state) => state.isModalVisible);
  const hideModal = useMaktabLiveStore((state) => state.hideModal);
  ...
  return (
    ...
    >
      <div className="relative h-auto w-full max-w-4xl">
        <div className="relative aspect-video w-full rounded-lg bg-white shadow dark:bg-gray-700 md:mt-20">
          <button
            type="button"
